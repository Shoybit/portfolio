...
export default function About() {
    return (
        <section id="about" className="py-12 md:py-20 px-4 md:px-8 lg:px-16 bg-gray-900 dark:bg-gray-900">
            <div className="container mx-auto">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-white  dark:text-white mb-8 md:mb-12">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-12 md:mb-16">
                    ...
                    <div className="text-center md:text-left">
                        <h2 className="text-xl md:text-2xl font-semibold text-white dark:text-white mb-3 md:mb-4">
                            A Bit About Me
                        </h2>
                        <p className="text-gray-400 dark:text-gray-400 leading-relaxed text-sm md:text-base">
                        ...
                        <div className="mt-6 md:mt-8 grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                            <div className="text-center p-3 md:p-4 bg-gray-800 dark:bg-gray-800 rounded-lg hover-lift">
                                <div className="text-2xl md:text-3xl text-primary font-bold">2+</div>
                                <div className="text-xs md:text-sm text-gray-400 dark:text-gray-400">Years Learning</div>
                            </div>
                            <div className="text-center p-3 md:p-4 bg-gray-800 dark:bg-gray-800 rounded-lg hover-lift">
                                <div className="text-2xl md:text-3xl text-primary font-bold">10+</div>
                                <div className="text-xs md:text-sm text-gray-400 dark:text-gray-400">Projects Completed</div>
                            </div>
                            <div className="text-center p-3 md:p-4 bg-gray-800 dark:bg-gray-800 rounded-lg hover-lift">
                                <div className="text-2xl md:text-3xl text-primary font-bold">100%</div>
                                <div className="text-xs md:text-sm text-gray-400 dark:text-gray-400">Dedication</div>
                            </div>
                        </div>
                    </div>
                </div>
